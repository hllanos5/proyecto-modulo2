import { listarCategoriaRepository, crearCategoriaRepository } from "../repository/CategoryRepository.js"
...
import { CODIGO_ERROR, USUARIO_COD_NO_ENCONTRADO, USUARIO_COD_SIN_PRIVILEGIOS, 
    USUARIO_COD_CORREO_REQUERIDO, USUARIO_COD_PASSWORD_REQUERIDO, CATEGORIA_COD_NOMBRE_REQUERIDO } from '../config/CodigosConfig.js';

import { USUARIO_NO_ENCONTRADO, USUARIO_SIN_PRIVILEGIOS, USUARIO_CORREO_REQUERIDO,
    USUARIO_PASSWORD_REQUERIDO, CATEGORIA_NOMBRE_REQUERIDO} from '../config/MensajesConfig.js';
