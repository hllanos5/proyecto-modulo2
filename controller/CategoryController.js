import { listarCategoriaRepository, crearCategoriaRepository, modificarCategoriaRepository, eliminarCategoriaRepository } from "../repository/CategoryRepository.js"
...
export const eliminarCategoria = async (req, res) => {
    ...
    try {
        ...
        const oRespuesta = await eliminarCategoriaRepository(req);
        return oRespuesta;
    } catch (error) {
        return {mensaje: error.message, codigo: CODIGO_ERROR}
    }
