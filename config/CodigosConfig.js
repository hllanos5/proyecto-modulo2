...
const COMENTARIO_COD_COMENTARIO_REQUERIDO = process.env['COMENTARIO_COD_COMENTARIO_REQUERIDO']
const COMENTARIO_COD_ID_REQUERIDO = process.env['COMENTARIO_COD_ID_REQUERIDO']
const COMENTARIO_COD_NO_ENCONTRADO = process.env['COMENTARIO_COD_NO_ENCONTRADO']
const COMENTARIO_COD_PUBLICACION_NO_USUARIO = process.env['COMENTARIO_COD_PUBLICACION_NO_USUARIO']
...
export { CODIGO_OK, CODIGO_ERROR, USUARIO_COD_NO_ENCONTRADO, USUARIO_COD_SIN_PRIVILEGIOS,
     ...
     COMENTARIO_COD_COMENTARIO_REQUERIDO, COMENTARIO_COD_ID_REQUERIDO, 
     COMENTARIO_COD_NO_ENCONTRADO, COMENTARIO_COD_PUBLICACION_NO_USUARIO }